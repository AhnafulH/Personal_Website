  ...
  return (
    ...
    ref={ref}>
      <div> 
          ...
          <p className="text-lg text-gray-600 py-5">what others say about me</p>
        </div>
      ...
      {/* <div className="w-full flex justify-center">
        ...
        <div className="gap-5 flex">
          ...
          fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, Ut enim ad minim veniam, quis nostrud exercitation 
        ...
        <div className="w-1/2 rounded-lg overflow-hidden shadow-lg bg-white p-6 border-2 border-red-300">
          ...
          <p className="text-gray-700 text-base mb-4 text-pretty tracking-normal leading-relaxed mt-7">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et 
          dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip 
          ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu 
          fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident,
